...
function TextInput({
  ...
  return (
    <input
      ...
      className="w-full rounded bg-slate-800 px-2 py-1 text-sm text-white"
    />
  );
}
...
function ChannelForm({
  ...
  return (
    <div className="p-2 text-slate-200">
      ...
      <button
        onClick={() => update(form)}
        className="mt-2 w-full rounded bg-blue-600 px-2 py-1 text-sm font-medium hover:bg-blue-500"
      >
        Save
      </button>
    </div>
    ...
    <div className="p-2 text-slate-200">
      ...
      <Field label="Definition">
        <textarea
          ...
          rows={8}
          className="w-full rounded bg-slate-800 px-2 py-1 font-mono text-sm text-white"
        />
      </Field>
      <button
        onClick={() => update(form)}
...
export default function PropertyPanel() {
  ...
  return (
    <div className="h-full overflow-auto border-l border-slate-800 bg-slate-900">
      {prefix === "ch" && (
        <ChannelForm
          architecture={architecture}
      ...
      <div className="px-2 pb-2">
        <button
          ...
          className="w-full rounded bg-red-700 px-2 py-1 text-sm font-medium hover:bg-red-600"
        >
          Delete
        </button>
      </div>
